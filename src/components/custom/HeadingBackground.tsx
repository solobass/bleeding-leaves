...
export function HeadingBackground({ children, className }: HeadingBackgroundProps) {
  return (
    <div className={`relative w-full py-1 md:py-2 mb-2 md:mb-4 flex justify-center px-2 md:px-6 ${className || ''}`}>
      <div className="relative w-full max-w-7xl">
        ...
        {/* Content */}
        <div className="relative z-10 flex items-center justify-center py-1 md:py-2 px-2 md:px-6">
          {children}
        </div>
      </div>
    </div>
